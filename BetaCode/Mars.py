...
def convertion_gray(img, Y):  # _________________________________________________________________________________DONE
    b, g, r = cv2.split(img)
    height = img.shape[0]
    width = img.shape[1]
...
def equalization(img):  # ______________________________________________________________________________________DONE
    height = img.shape[0]
    width = img.shape[1]
    Hist = np.zeros(400)
    CDF = np.zeros(256)
